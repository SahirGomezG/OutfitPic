...
import { Modal, View, Text, StyleSheet, TouchableOpacity, SafeAreaView, TextInput, Image, ImageBackground, TouchableWithoutFeedback, Keyboard, Switch, FlatList, TouchableHighlight, Dimensions} from "react-native";
...
class OutfitPostScreen extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            text: "",
            image: 'https://lh3.googleusercontent.com/-O21uHkUnuq25SIdMP63NotDP_kh65s09N5Ud7Nvh2pfJ38-7_Yzc5tWNkQGehySuDg8EKuz4fso8vBRF_MeBw5V',
            user: {},
            fileList:[],
            count: 0,
            duration: 24,
    ...
    componentDidMount() {
        ...
        this.unsubscribe = currentuserRef
            .onSnapshot(doc => {
    ...
    emptyComponent = () => {
      return (
        <View style={{ marginHorizontal: 80, marginTop: 10, height: 250, width: 225, borderRadius: 18, alignContent: 'center' }}>
              ...
              <View style={styles.mediaImageContainer}>
                  <ImageBackground source={{ uri: item.url }} style={styles.image} resizeMode="cover">  
                      <TouchableHighlight onPress={() => this.deleteItem(item)}>
                          <Icon name="md-trash" size={25} color="white" style={{ position: 'absolute', top: 10, right: 10 }}></Icon>
                      </TouchableHighlight>   
                  </ImageBackground>             
              </View>
        )
            ...
            <View style={styles.container}>
              <View style={styles.header}>
                  ...
                  <TouchableOpacity onPress={this.handleOutfitPost}>
                      <Text style={{ fontWeight: "400", fontFamily: "HelveticaNeue", color: '#FFF', fontSize: 16 }}>Share</Text>
                  </TouchableOpacity>
              </View>
              ...
              <View style={styles.section}>  
                  <TouchableOpacity style={styles.addImage} onPress={this.onClickAddImage}>
              ...
              <View style={styles.section}>
                ...
                <TouchableOpacity onPress={() => {this.setModalVisible(true);}}>
                  ...
                  <View style={styles.option}>
                      <Text style={{ fontWeight: "400",color: "#4F566D",fontFamily: "HelveticaNeue" }}>Private Poll </Text>
                      <View style={{ marginRight: 20 }}><Icon name="ios-lock" size={24} color={ privatePoll === false ? "#EAEAED" : "#FF7657" }/></View> 
                  </View>
                </TouchableOpacity> 

                  <View style={styles.option}>
                      <Text style={{ fontWeight: "400",color: "#4F566D",fontFamily: "HelveticaNeue" }}>Block Comments    </Text>
                      <Switch
                        value={comments}
                  ...
                  <View style={styles.section}>
                        ...
                        <TouchableOpacity
                            style={[styles.button, styles.last, duration === 1 ? styles.active : null]}
                          ...
                          <View style={{flex:1, alignItems:'center', justifyContent:'center',marginTop: 22}}>
                            <View style={styles.modal}>
                              ...
                              <TouchableOpacity
                                  ...
                                  <Text style={{color: "#514E5A",fontWeight: "200" }}>Close</Text>
                              </TouchableOpacity>
                              ...
                              <TouchableOpacity onPress={() => this.setState({ privatePoll: false })}>
                              <View style={styles.section}>
                                <View style={styles.optionsModal}>
                                  <Icon name="md-globe" size={22} color="#4F566D" style={{ marginRight: 15 }}/>
                                  <View style={{ width:200 }}>
                                    <Text style={{ fontWeight: "400",color: "#4F566D",fontFamily: "HelveticaNeue" }}>Public</Text>
                                    <Text style={{ color: "#4F566D",fontFamily: "HelveticaNeue", fontSize:10 }}>Visible to everyone on the Internet</Text>
                                  </View> 
                                  {!privatePoll ? (<Icon name="ios-checkbox" size={22} color="#12A40B" />) : null}
                                </View>
                              </View> 
                              </TouchableOpacity>  
                              
                              <TouchableOpacity onPress={() => this.setState({ privatePoll: true })}>
                              <View style={styles.section}>
                                <View style={styles.optionsModal}>
                                  <Icon name="ios-people" size={22} color="#4F566D" style={{ marginRight: 15 }}/>
                                  <View style={{ width:200 }}>
                                    <Text style={{ fontWeight: "400",color: "#4F566D",fontFamily: "HelveticaNeue" }}>Only Folllowers</Text>
                                    <Text style={{ color: "#4F566D",fontFamily: "HelveticaNeue", fontSize:10 }}>Visible to you and your OutfitPic followers</Text>
                                  </View> 
                                  {privatePoll ? (<Icon name="ios-checkbox" size={22} color="#12A40B" />) : null}
                                </View>
                              </View> 
                ...
                <View style={styles.mediaCount}>
                    <Text style={[styles.text, { fontSize: 20, color: "#DFD8C8", fontWeight: "300" }]}>{this.state.count}</Text>
                    <Text style={[styles.text, { fontSize: 10, color: "#DFD8C8", textTransform: "uppercase" }]}>Outfits</Text>
                </View>
